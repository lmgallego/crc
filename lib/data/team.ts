...
export const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    bioParagraphs: {
      es: [
        'Daniel Sanabria es Doctor por la Universidad de Oxford (Inglaterra) y Catedrático en el Departamento de Psicología Experimental de la Facultad de Psicología de la Universidad de Granada. Es Director del laboratorio "Cognitive & Affect Dynamics" (grupo de investigación "Human Brain & Cognition") del Centro de Investigación Mente, Cerebro y Comportamiento (CIMCYC) de la Universidad de Granada.',
      ...
      en: [
        'Daniel Sanabria holds a PhD from the University of Oxford (England) and is Full Professor in the Department of Experimental Psychology at the Faculty of Psychology of the University of Granada. He is Director of the "Cognitive and Affective Dynamics" laboratory (Human Brain & Cognition research group) at the Mind, Brain and Behaviour Research Centre (CIMCYC) of the University of Granada.',
